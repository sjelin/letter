...
transGif = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";

function injectText(text) {
	var paragraphs = ((text||"").trim() || defaultText).split("\n");

	if((paragraphs[0].indexOf("://") == -1) &&
			(paragraphs[0].indexOf("data:") == -1))
		paragraphs.unshift(transGif, "");//Add image info
	...
	//Date
	var d = new Date();
	$(".date").text(["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"][d.getMonth()] + " " + d.getDate() + ", " + (1990 + d.getYear()));
...
defaultText =	"data:image/gif;base64,R0lGODlhAQABAIAAAAUEBAAAACwAAAAAAQABAAACAkQBADs=\n"+
				...
				"Vivamus vitae lacinia neque, eu rutrum mauris. Proin lacinia mauris non mi tempus rhoncus. Phasellus commodo nibh quis hendrerit aliquam. Pellentesque sit amet eros purus. Phasellus sit amet blandit orci. Nulla felis tellus, vestibulum ac libero id, vulputate adipiscing turpis. Mauris ac consequat tellus.\n"+
				"Nulla quis consectetur leo. Curabitur suscipit pellentesque augue a pulvinar. Morbi aliquam ligula in mauris fermentum, nec pharetra neque posuere. Nullam eget euismod nulla, eu tincidunt eros. Curabitur luctus ac felis nec sagittis. Proin feugiat sollicitudin vulputate.";
